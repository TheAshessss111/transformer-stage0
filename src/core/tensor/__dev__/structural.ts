/**
 * Structural invariants — T14.
 *
 * NdArray construction and iteration, the shape-op view/copy contract,
 * broadcasting and its dual, forward operators, the PRNG, and formatting.
 */

import { check, expect, group } from './harness.ts';
import { flatEquals, record, throws } from './assertions.ts';
import {
  NdArray,
  at,
  clone,
